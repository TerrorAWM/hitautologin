...
```bash
hitautologin/
├── Chrome Extension/       # 浏览器扩展版（完整版，推荐）
│   ├── manifest.json
│   ├── background.js
│   ├── content.js
│   ├── popup.html
...
前往 [GreasyFork 脚本页](https://greasyfork.org/zh-CN/scripts/507678-hit-%E6%A0%A1%E5%9B%AD%E7%BD%91%E7%AB%99%E8%87%AA%E5%8A%A8%E7%99%BB%E5%BD%952-0)，点击 **安装此脚本**。
安装后即可自动更新至最新版本。
